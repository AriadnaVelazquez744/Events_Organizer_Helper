...
def TRANSFORM_INITIAL_QUERY_EN(schema, user_input, context): 
    ...
    2. For enum fields, only use the exact values specified in the schema:
       - Cuisines: only "Pan-Asian", "Pan-European", "Southern", "Latin American", "American", "BBQ", "Italian"
       - Dietary options: only "Dairy-free", "Gluten-free", "Nut-free", "Vegan", "Vegetarian"
       - Atmosphere: only "Indoor", "Outdoor", "Rustic Chic"
